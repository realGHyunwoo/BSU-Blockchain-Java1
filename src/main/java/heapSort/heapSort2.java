...
//        else heapSort(heap, heap2, cnt, cntHeap);
//    }
////    static void heapSort(int []heap,int []heap2,int[] cnt,int[] cntHeap) {   //loop 1번만 돌려서 수정 : 성능 향상
////        int n = heap2[0];
////        int result = 0;
////        for ( int i=0; i<n; i++) {
////           result = deleteHeap();
...
//        for (int leaf=cnt[0]; leaf>=(cnt[0]/2)+1;leaf--)
//        {
//            int current=leaf;
//            while(current!=1)
//            {
