...
//
//
//    static void mergeSort(linkedList[] arr,int leng) {
//
...
//
//            }
//            first.setData(arr[i*2+1].getHead().getData()+arr[i*2].getHead().getData());
//            arr[i*2]=null;
//            arr[i*2+1]=null;
//            arr[i].setHead(first);
//        }
...
//
//    }
//    static int getData(linkedList[]l){
...
//        int n=0;
//        int leng=arr[1].getHead().getData()-1;
...
//        linkedList arr[] = new linkedList[size*2];
//        int leng=getData(arr);
//        show(arr);
//        splitData(arr);
//        show(arr);
//        mergeSort(arr, leng);
